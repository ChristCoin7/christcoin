...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "christcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"christco.in", "christco.in"},
    {"eu.christco.in", "eu.christco.in"},
    {"asia.christco.in", "asia.christco.in"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. christcoin is probably already running."), addrBind.ToString().c_str());
        else
